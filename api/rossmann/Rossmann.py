...
class Rossmann(object):
  def __init__(self):
    ...
    self.home_path='C:/Users/User/Desktop/repositório de DS/Curso_ds_em_producao/'
    self.competition_distance_scaler       =pickle.load(open(self.home_path +'parameter/competition_distance_scaler.pkl','rb'))
    self.competition_time_month_scaler     =pickle.load(open(self.home_path +'parameter/competition_time_month_scaler.pkl','rb'))
    self.competition_promo_time_week_scaler=pickle.load(open(self.home_path +'parameter/promo_time_week_scaler.pkl','rb'))
    self.competition_year_scaler           =pickle.load(open(self.home_path +'parameter/year_scaler.pkl','rb'))
  ...
  def data_preparation(self,df5):
    ...
    pickle.dump(rs,open('C:/Users/User/Desktop/repositório de DS/Curso_ds_em_producao/parameter/competition_distance_scaler.pkl','wb'))

    #competition time month
    df5['competition_time_month']=self.competition_time_month.fit_transform(df5[['competition_time_month']].values)
    pickle.dump(rs,open('C:/Users/User/Desktop/repositório de DS/Curso_ds_em_producao/parameter/competition_time_month_scaler.pkl','wb'))

    #promo time week  
    df5['promo_time_week']=self.promo_time_week.fit_transform(df5[['promo_time_week']].values)
    pickle.dump(rs,open('C:/Users/User/Desktop/repositório de DS/Curso_ds_em_producao/parameter/promo_time_week_scaler.pkl','wb'))
